...
class Gun_ViewController: UIViewController {

    let questions = activeShooterSafetyQuestions.shuffled()
    ...
    func setQuestion()
    {
        ...
        answer0.backgroundColor = UIColor.init(displayP3Red: 0.78, green: 0.96, blue: 1.0, alpha: 1)
        answer1.backgroundColor = UIColor.init(displayP3Red: 0.78, green: 0.96, blue: 1.0, alpha: 1)
        answer2.backgroundColor = UIColor.init(displayP3Red: 0.78, green: 0.96, blue: 1.0, alpha: 1)
        answer3.backgroundColor = UIColor.init(displayP3Red: 0.78, green: 0.96, blue: 1.0, alpha: 1)

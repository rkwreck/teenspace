...
class drug_ViewController: UIViewController {

    let questions = drugQuestions.shuffled()
    ...
    {
        //lblProgress.text = "\(currentQuestionPos+1) / \(15)"
    ...
    func setQuestion()
    {
        ...
        answer0.backgroundColor = UIColor.init(displayP3Red: 0.84, green: 0.99, blue: 0.96, alpha: 1)
        answer1.backgroundColor = UIColor.init(displayP3Red: 0.84, green: 0.99, blue: 0.96, alpha: 1)
        answer2.backgroundColor = UIColor.init(displayP3Red: 0.84, green: 0.99, blue: 0.96, alpha: 1)
        answer3.backgroundColor = UIColor.init(displayP3Red: 0.84, green: 0.99, blue: 0.96, alpha: 1)
    ...
    /*
    var Qcontroller = QuestionController(questions:drugQuestions,
                                         answer0:answer0,
                                         answer1: answer1,
                                         answer2: answer2,
                                         answer3: answer3,
